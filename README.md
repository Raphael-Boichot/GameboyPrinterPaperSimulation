...
- *In general, each time you used Automatic mode, if the images decoded are splitted, ill-assembled or in brief, not what you expect, use Manual mode instead.*
